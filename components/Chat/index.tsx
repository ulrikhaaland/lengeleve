  ...
  return (
    <div className='w-9/12 h-max'>
      ...
      <div
        ...
        style={{ maxHeight: 'calc(95vh - 50px)' }}
        onClick={() => {
          setBgClicked(true);
        }}
      >
        <div
          className='flex-1 text-grey overflow-auto mb-12 overflow-auto max-h-screen w-full max-w-[750px]'
          style={{ maxHeight: 'calc(95vh - 50px)' }}
          ref={divRef}
        >
          <div className='mx-auto flex h-full flex-col px-3 w-full max-w-[750px]'>
            <QuestionsList
              questions={questions}
              answers={answers}
