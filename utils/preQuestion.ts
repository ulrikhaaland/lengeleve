      ...
      messages: [
        {
          role: 'user',
          content: endent`
            I need a question that is health related, it should be related to exercise, nutrition, sleep, cardiovascular health, lipids, blood pressure, blood sugar, or something similar.
